...
import { HomeHeroPixel } from "@/components/home/home-hero-pixel";
    ...
    <div className="mx-auto w-full max-w-screen-2xl space-y-10 pb-8">
      <section className="border-b-4 border-[var(--pixel-border)] pb-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-10">
          <p className="max-w-xl font-[family-name:var(--font-pixel-body)] text-base leading-relaxed text-[var(--pixel-muted)]">
